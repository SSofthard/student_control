...
class nucleo(osv.osv):
    ...
    _columns={
        'nombre':fields.char('Sede',size=120,required=True,help='Aquí se coloca el nombre de la sede'),
        'decano':fields.char('Decano',size=120,required=True,help='Aquí se coloca el nombre del decano de la sede'),
        'unidad_academica':fields.char('Jefe Unidad Académica',size=120,required=True,help='Aquí se coloca el nombre del jefe de la unidad académica'),
        ...
        'direccion':fields.char('Dirección',size=180,required=True,help='Aquí se coloca la dirección de la sede'),
